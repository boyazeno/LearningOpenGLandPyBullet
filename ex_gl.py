...
class GLWidget(QOpenGLWidget):
    ...
    def initializeGL(self):
        ...
        #version_profile.setVersion(3, 1)
    ...
    def paintGL(self):
        ...
        self.gl.glTranslated(self.xTrans,self.yTrans,self.zTrans)
        ...
        self.gl.glTranslated(-3.0,+2.2,-1.8)
        self.gl.glRotated(+90.0, 1.0, 0.0, 0.0)
        self.drawGear(self.gear3, 0, 0, 0,
    ...
    def wheelEvent(self, event):
        ...
        self.setZTranslation(self.zTrans + deltaAngle/120.0)
        self.update()
    ...
    def mouseMoveEvent(self, event):
        ...
        if event.buttons() & Qt.LeftButton:
            ...
            self.setXTranslation(self.xTrans + dx/10.0)
            self.setYTranslation(self.yTrans - dy/10.0)
